...
\newcommand{\intitule}{Complément de Programmation\\
Recherche du plus grand sous-tableau préfixe-suffixe}
\newcommand{\GrNbr}{09}
\newcommand{\PrenomUN}{Muhammad}
\newcommand{\NomUN}{Qayyum}
\newcommand{\PrenomDEUX}{Nathan}
\newcommand{\NomDEUX}{Collard}
